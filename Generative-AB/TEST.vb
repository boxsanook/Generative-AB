...
Public Class TEST
    ...
    '    Dim tdes As New TripleDES()
    '    TextBox5.Text = tdes.xDecrypt(TextBox5.Text)
    'End Sub

    'Function decrypt(ByVal encryptedData As String, ByVal key As String) As String
    '    Dim dataParts() As String = encryptedData.Split(":"c)
    '    Dim cipherText As Byte() = Convert.FromBase64String(dataParts(0))
    '    Dim iv As Byte() = Convert.FromBase64String(dataParts(1))
